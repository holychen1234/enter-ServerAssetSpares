...
export const listNetworkDevices = impl.listNetworkDevices;
export const getNetworkDevice = impl.getNetworkDevice;
export const createNetworkDevice = impl.createNetworkDevice;
export const updateNetworkDevice = impl.updateNetworkDevice;
export const deleteNetworkDevice = impl.deleteNetworkDevice;
export const batchDeleteNetworkDevices = impl.batchDeleteNetworkDevices;
export const listWorkstations = impl.listWorkstations;
export const getWorkstation = impl.getWorkstation;
export const createWorkstation = impl.createWorkstation;
export const updateWorkstation = impl.updateWorkstation;
export const deleteWorkstation = impl.deleteWorkstation;
export const batchDeleteWorkstations = impl.batchDeleteWorkstations;
