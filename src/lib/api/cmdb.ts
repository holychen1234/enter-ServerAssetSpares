...
export const listTerminalAssets = impl.listTerminalAssets;
export const getTerminalAsset = impl.getTerminalAsset;
export const createTerminalAsset = impl.createTerminalAsset;
export const updateTerminalAsset = impl.updateTerminalAsset;
export const deleteTerminalAsset = impl.deleteTerminalAsset;
export const batchDeleteTerminalAssets = impl.batchDeleteTerminalAssets;
